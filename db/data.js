export default function calculateData(parameter) {
  ...
  const commonEnemiesData = {
    0: [
      ...
      [
        0.3437, 0.3664, 0.4004, 0.8021, 0.8837, 1.2866, 1.4231, 1.5044, 1.5317,
        1.5861, 1347,
      ],
    ],
    1: [
      ...
      [
        0.2149, 0.229, 0.2503, 0.5011, 0.5523, 0.8038, 0.8893, 0.9399, 0.9573,
        0.9914, 2070,
      ],
    ],
    2: [
      ...
      [
        1.289, 1.3739, 1.5015, 3.0084, 3.3144, 4.8261, 5.3366, 5.6421, 5.7441,
        5.9481, 226,
      ],
    ],
    3: [
      ...
      [
        0.4338, 0.4623, 0.5053, 1.0082, 1.1107, 1.6155, 1.7859, 1.888, 1.9223,
        1.9906, 586,
      ],
    ],
    4: [
      ...
      [
        2.1483, 2.2898, 2.5025, 5.0139, 5.5242, 8.044, 8.8942, 9.4031, 9.5737,
        9.9139, 260,
      ],
    ],
    5: [
  ...
  const eliteEnemiesData = {
    0: [
      ...
      [
        0.8056, 0.8587, 0.9385, 1.8801, 2.0716, 3.0168, 3.336, 3.5269, 3.5912,
        3.7189, 365,
      ],
    ],
    1: [
      ...
      [
        1.1413, 1.2165, 1.3295, 2.6636, 2.9349, 4.2729, 4.725, 4.9954, 5.0859,
        5.2665, 156,
      ],
    ],
    2: [
      ...
      [
        1.3427, 1.4312, 1.5641, 3.1335, 3.4527, 5.0282, 5.5596, 5.8781, 5.9845,
        6.197, 144,
      ],
    ],
    3: [
    ...
    9: [
      ...
      [
        3.3568, 3.5779, 3.9103, 7.8342, 8.6316, 12.5703, 13.8993, 14.6956,
        14.962, 15.4934, 13.56,
      ],
    ],
    10: [
      [
    ...
    11: [
      ...
      [
        2.014, 2.1467, 2.3461, 4.7006, 5.1791, 7.542, 8.3389, 8.8165, 8.9764,
        9.2953, 50,
      ],
    ],
    12: [
    ...
    16: [
      ...
      [
        1.114, 1.2467, 2.3461, 4.7006, 5.1791, 7.542, 8.3389, 8.8165, 8.9764,
        9.2953, 27,
      ],
    ],
    17: [
